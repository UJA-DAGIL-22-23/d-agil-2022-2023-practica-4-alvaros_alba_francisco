...
https://trello.com/b/YYQ32O06/practica4
   ...
   En el incremento se han hecho las funcionalidades:
...
1. Ofrecer en la aplicación toda la funcionalidad de la práctica individual creada por la estudiante Alba Gómez.
2. Ofrecer en la aplicación toda la funcionalidad de la práctica individual creada por el/la estudiante Álvaro Martín.
3. Ofrecer en la aplicación toda la funcionalidad de la práctica individual creada por el estudiante Álvaro Herrera.
4. Ofrecer en la aplicación toda la funcionalidad de la práctica individual creada por el estudiante Álvaro Ordóñez.
5. Ofrecer en la aplicación toda la funcionalidad de la práctica individual creada por el estudiante Francisco Ortega.
...
El equipo ha trabajado arduamente en la implementación de estas historias de usuario y ha logrado completarlas dentro del plazo establecido. Las capturas de pantalla se pueden ver anteriormente.
...
## SPRINT RETROSPECTIVE - Proyecto de Aplicación de Microservicios
