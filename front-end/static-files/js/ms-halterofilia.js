/**
 * @file ms-halterofilia.js
 * @description Funciones para el procesamiento de la info enviada por el MS Halterofilia
...
Halterofilia.datosDescargadosNulos =
{
 ...
 */
Halterofilia.cabeceraTableNombre = function () {
    return `<table class="listado-nombres"><thead><th>Nombre del deportista</th></thead><tbody><a href="javascript:Halterofilia.listarAlf()" class="opcion-principal mostrar"title="Listar todos los nombres de los deportistas en la base de datos en órden alfabético">Ordenar Alfabéticamente</a>`;
}
 ...
 */
Halterofilia.cuerpoTrNombre = function (p) {
    const d = p.data
 ...
 */
Halterofilia.pieTableNombre = function () {
    return "</tbody></table>";
}
 ...
 * @returns Cabecera de la tabla 
 */
Halterofilia.cabeceraTable = function () {
 ...
 */
Halterofilia.cuerpoTr = function (p) {
    const d = p.data
    ...
    return `<tr title="${p.ref['@ref'].id}">
        ...
        <td>${d.logros}</td>
        <td>
            <div class="guardar-btn"><a href="javascript:Halterofilia.modifyNombre('${p.ref['@ref'].id}')">Editar Nombre</a></div>
        </td>
        <td>
            <div class="guardar-btn"><a href="javascript:Halterofilia.modifyCampos('${p.ref['@ref'].id}')">Editar</a></div>
        </td>
    </tr>`;
}
 ...
 * @returns Cadena conteniendo el pie de tabla
 */
Halterofilia.pieTable = function () {
    return "</tbody></table>";
}
...
/**
 * Función que descarga la info MS Halterofilia al llamar a una de sus rutas
 * @param {string} ruta Ruta a descargar
 * @param {función} callBackFn Función a la que se llamará una vez recibidos los datos.
 */
Halterofilia.descargarRuta = async function (ruta, callBackFn) {
    let response = null
...
/**
 * Función principal para mostrar los datos enviados por la ruta "home" de MS Halterofilia
 */
Halterofilia.mostrarHome = function (datosDescargados) {
    ...
    Frontend.Article.actualizar("Halterofilia Home", datosDescargados.mensaje)
}

//PARA MOSTRAR LOS DATOS DE ACERCA DE
/**
 * Función principal para mostrar los datos enviados por la ruta "acerca de" de MS Halterofilia
 */
Halterofilia.mostrarAcercaDe = function (datosDescargados) {
    // Si no se ha proporcionado valor para datosDescargados
    datosDescargados = datosDescargados || this.datosDescargadosNulos
    ...
    `;
    Frontend.Article.actualizar("Halterofilia Acerca de", mensajeAMostrar)
}
 ...
 */
Halterofilia.imprimeDeportistas = function (vector) {

    let msj = "";
    msj += Halterofilia.cabeceraTableNombre();
    vector.data.forEach(e => msj += Halterofilia.cuerpoTrNombre(e))
    msj += Halterofilia.pieTableNombre();
 ...
 * @param {Vector_de_deportistas} vector Vector con los datos de los deportistas a mostrar
 */
Halterofilia.imprimeCompleto = function (vector) {
    let msj = "";
    msj += Halterofilia.cabeceraTable();
    vector.data.forEach(e => msj += Halterofilia.cuerpoTr(e))
 ...
 */
Halterofilia.imprimeDeportista = function (deportistaUnico) {
    let msj = "";
    msj += Halterofilia.cabeceraTable();
    msj += Halterofilia.cuerpoTr(deportistaUnico)
    msj += Halterofilia.pieTable();
 ...
 * @param {Vector_de_deportistas} vector Vector con los datos de los deportistas a mostrar
 */
Halterofilia.imprimePorCampo = function (campoOrden, vector) {
    let msj = "";
    msj += Halterofilia.cabeceraTable();
    ...
    ordenados.forEach(e => msj += Halterofilia.cuerpoTr(e));
    msj += Halterofilia.pieTable();
...
/**
  ...
  * @param {Vector_de_deportistas} vector Vector con los datos de los deportistas a mostrar
  */
Halterofilia.mostrarDeportistasPorNombre = function (busqueda, vector) {
    ...
    let msj = "";
    msj += Halterofilia.cabeceraTable();
    deportistasFiltrados.forEach(e => msj += Halterofilia.cuerpoTr(e));
    msj += Halterofilia.pieTable();
    Frontend.Article.actualizar("Listado de deportistas completo ordenado ", msj);
    return msj;
}
 ...
 */
Halterofilia.modificarNombre = function (deportista) {
        ...
        <table width="100%" class="listado-personas">
            ...
            <tbody>
                <tr title="${deportista.ref["@ref"].id}">
                    ...
                    <td>
                    <div class="guardar-btn"><a href="javascript:Halterofilia.guardar('358470619171389645')">Guardar</a></div>
                    </td>
                </tr>
            </tbody>
        </table>
 ...
 */
Halterofilia.modificarCampos = function (deportista) {
    let msj = `<form method='post' action=''>
    <table width="100%" class="listado-personas">
        <thead>
        <table class="listado-deportistas"><thead><th>Nombre</th><th>Apellidos</th><th>País</th><th>Categoría</th><th>Sexo</th><th>Fecha nacimiento</th><th>Medallas ganadas</th><th>Años participación</th><th>Logros</th></thead><tbody>
 ...
 */
Halterofilia.nuevoDeportista = function () {
    let msj = `<form method='post' action=''>
        <table width="100%" class="listado-personas">
            <thead>
            <table class="listado-deportistas"><thead><th>Nombre</th><th>Apellidos</th><th>País</th><th>Categoría</th><th>Sexo</th><th>Fecha nacimiento</th><th>Medallas ganadas</th><th>Años participación</th><th>Logros</th></thead><tbody>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                    <div class="guardar-btn"><a href="javascript:Halterofilia.guardarNuevoDeportista()">Guardar</a></div>
                    </td>
                </tr>
            </tbody>
        </table>
 ...
 * @param {String} idDeportista id del deportista a mostrar
 */
Halterofilia.mostrarDeportista = function (idDeportista) {
 ...
 */
Halterofilia.listarCompletoT = function () {
...
*/
Halterofilia.busquedaNombre = function () {
 ...
 */
Halterofilia.modifyNombre = function (idDeportista) {
 ...
 * @param {String} idDeportista id del deportista que se debe actualizar
 */
Halterofilia.modifyCampos = function (idDeportista) {
...
Halterofilia.guardar = async function (id_deportista) {
    try {
        ...
        Halterofilia.mostrarDeportista(id_deportista);
    } catch (error) {
        alert("Error: No se han podido acceder al API Gateway " + error)
    }
}